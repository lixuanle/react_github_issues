  ...
  render() {
    ...
    return (
      <div className="issue-container">
        ...
        <p className="issue-text">Created on {this.props.date} by <a href={this.props.author.html_url} className="author-link" href="_blank" rel="noopener noreferrer">{this.props.author.login}</a> <img src={this.props.author.avatar_url} className="avatar-pic" alt="avatar-pic"/></p>
      </div>
    )
  }
}
